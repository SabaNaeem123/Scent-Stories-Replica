...
document.getElementById("contactForm").addEventListener('submit', function(event) {
  event.preventDefault();
                      ...
                      if (
                        ...
                        /\d/.test(password) && // At least one numerical digit
                        /[a-zA-Z]/.test(password) // At least one alphabet character
                    ) {
    ...
    setTimeout(function(){
     ...
     setTimeout(function(){
      ...
      resultDiv.innerHTML=`"Sign-in complete. Ready to explore your account."`
     ...
     setTimeout(function(){
      document.getElementById('contactForm').reset()
              ...
              setTimeout(function(){
                const resultDiv=document.getElementById('answer');
                resultDiv.innerHTML=`
                <p> <u><li> Incorrect email or password </u></li></p>`;
