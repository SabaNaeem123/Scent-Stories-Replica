...
function toggleDropdown() {
    ...
    if (dropdownVisible) {
        dropdownContent.innerHTML = 
            '<a href="https://scentsnstories.pk/collections/week-2/men?sort_by=title-ascending">Sort</a>' +
            '<a href="https://scentsnstories.pk/collections/week-2?sort_by=manual">Featured</a>' +
            '<a href="https://scentsnstories.pk/collections/week-2?sort_by=best-selling">Best selling</a>' +
            '<a href="https://scentsnstories.pk/collections/week-2?sort_by=title-ascending">Alphabetically, A-Z</a>' +
            '<a href="https://scentsnstories.pk/collections/week-2?sort_by=title-descending">Alphabetically, Z-A</a>'+
            '<a href="https://scentsnstories.pk/collections/week-2?sort_by=price-ascending">Price, low to high</a>'+
            '<a href="https://scentsnstories.pk/collections/week-2?sort_by=price-descending">Price, high to Low</a>'+
            '<a href="https://scentsnstories.pk/collections/week-2?sort_by=created-ascending">Date, old to new</a>'+
            '<a href="https://scentsnstories.pk/collections/week-2?sort_by=created-descending">Date, new to old</a>';
