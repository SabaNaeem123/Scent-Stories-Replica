...
document.addEventListener("DOMContentLoaded", function () {
  scrollToTop(); // Scroll to top when the page loads
  animateText(); // Start animating text after scrolling to top
});
...
if (username) {
  ...
  document.getElementById("account").style.letterSpacing="6px"
  document.getElementById("account").style.fontSize="200px"
  
 account.classList.add("user")

}
else{
  document.getElementById("account").innerHTML = 'A C C O U N T';
}
var name=username;
